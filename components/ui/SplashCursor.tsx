...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      const webgl2 = isWebGL2 ? webgl as WebGL2RenderingContext : null;
      ...
      const halfFloatTexType = isWebGL2 ? webgl2!.HALF_FLOAT : halfFloat && halfFloat.HALF_FLOAT_OES;
      let formatRGBA;
      let formatRG;
      let formatR;

      if (isWebGL2) {
        formatRGBA = getSupportedFormat(webgl2!, webgl2!.RGBA16F, webgl2!.RGBA, halfFloatTexType);
        formatRG = getSupportedFormat(webgl2!, webgl2!.RG16F, webgl2!.RG, halfFloatTexType);
        formatR = getSupportedFormat(webgl2!, webgl2!.R16F, webgl2!.RED, halfFloatTexType);
      } else {
    ...
    function getSupportedFormat(gl: any, internalFormat: number, format: number, type: any) {
    ...
    function supportRenderTextureFormat(gl: any, internalFormat: number, format: number, type: any) {
