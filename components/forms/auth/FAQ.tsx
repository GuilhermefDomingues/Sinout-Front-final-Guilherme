...
// --- Estilos Globais para Animações Personalizadas ---
// Isso define as animações de flutuar e de movimento do fundo
const customStyles = `
  @keyframes float {
...
// Componente Individual do Accordion (Item da FAQ)
const FAQItem = ({ icon: Icon, question, answer, isOpen, toggle }: FAQItemProps) => {
  return (
    <div className="mb-4">
      ...
      <div
        className={`grid transition-all duration-300 ease-in-out overflow-hidden text-slate-600 dark:text-slate-300 ${
          isOpen 
    ...
    <>
      ...
      <div className="min-h-screen bg-background text-foreground transition-colors duration-300 overflow-x-hidden relative">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
            ...
            {/* NOVOS: Elementos flutuantes em movimento */}
        ...
        <main className="container mx-auto px-4 pt-32 pb-20 max-w-4xl relative z-10">
          ...
          <div className="text-center mb-14 space-y-4">
            {/* Adicionada a classe 'floating' para animar o container do ícone */}
